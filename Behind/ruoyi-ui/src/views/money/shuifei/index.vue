<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="list">
      <el-table-column label="水费ID" align="center" prop="waterId" width="90" />
      ...
      <el-table-column label="用水量" align="center" prop="usedAmount" />
...
<script>
import { listShuifei } from '@/api/shuifei/shuifei'
...
export default {
  ...
  methods: {
    getList() {
      this.loading = true
      listShuifei(this.queryParams).then(response => {
