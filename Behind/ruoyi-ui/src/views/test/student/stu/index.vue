...
<script>
import { listStu, getStu, delStu, addStu, updateStu } from "@/api/student/stu"
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('student/stu/export', {
        ...this.queryParams
