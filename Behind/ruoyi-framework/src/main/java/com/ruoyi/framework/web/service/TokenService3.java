 ...
 * @author ruoyi
 */
// @Component  // disabled to avoid duplicate bean conflict
public class TokenService3
{
    private static final Logger log = LoggerFactory.getLogger(TokenService3.class);
