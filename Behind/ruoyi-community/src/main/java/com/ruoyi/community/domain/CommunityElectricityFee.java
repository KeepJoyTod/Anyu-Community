...
public class CommunityElectricityFee extends BaseEntity {
    ...
    // getters and setters
    public Long getElectricityId() { return electricityId; }
    public void setElectricityId(Long electricityId) { this.electricityId = electricityId; }
